...
/// 4.1
int buscaPosMenor(int T[], int validos);
/// 4.2
float porcentajeMayores(int T[], int validos, int limite);
/// 4.3
void subProgramaPorcentajeArreglosYposMenor(int T[], int validos);
...
int main()
{
    ...
    subProgramaPorcentajeArreglosYposMenor(arregloDeTemperaturas, tempsCargadas);
...
void subProgramaPorcentajeArreglosYposMenor(int T[], int validos)
{
    int valorReferencial=0, pos;

    float porcent=0;

    pos=buscaPosMenor(T, validos);

    printf("Ingrese la temperatura referencial para calcular el porcentaje: ");
    scanf("%d",&valorReferencial);

    porcent=porcentajeMayores(T, validos, valorReferencial);

    printf("El porcentaje de temperaturas \"superiores\" a %d grados  fue de %.2f %%\n\n", valorReferencial, porcent);

    printf("La pos del menor elemento es %d y su valor es %d", pos, T[pos]);
...
void menu()
{
    ...
    printf("4- Porcentaje temperaturas inferiores y posMenor \n\n");
